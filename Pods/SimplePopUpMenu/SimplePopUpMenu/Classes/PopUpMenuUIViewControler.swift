...
public class PopUpMenuUIViewControler: UIViewController{
    ...
    private func calculateContentSizes(){
        ...
        for item in self.items{
            ...
            let fsize: CGSize = myString.size(withAttributes: [NSAttributedString.Key.font: UIFont.systemFont(ofSize: PopUpMenuUIViewControler.fontSize)])
...
@discardableResult fileprivate func configureConstraints(
    ...
    if let superView:UIView = childView.superview {
        ...
        if let t = top {
            constraint = NSLayoutConstraint(item: childView, attribute:NSLayoutConstraint.Attribute.top,relatedBy: NSLayoutConstraint.Relation.equal,toItem: superView,attribute: NSLayoutConstraint.Attribute.top,multiplier: 1,constant: t)
            result["top"] = constraint
            superView.addConstraint(constraint!)
        }
        
        
        constraint = NSLayoutConstraint(item: childView,attribute: NSLayoutConstraint.Attribute.leading,relatedBy: NSLayoutConstraint.Relation.equal,toItem: superView,attribute: NSLayoutConstraint.Attribute.leading,multiplier: 1,constant: left)
        ...
        if let r = right {
            constraint = NSLayoutConstraint(item: childView,attribute: NSLayoutConstraint.Attribute.trailing,relatedBy: NSLayoutConstraint.Relation.equal,toItem: superView,attribute: NSLayoutConstraint.Attribute.trailing,multiplier: 1,constant: r)
        ...
        if let b = bottom {
            constraint = NSLayoutConstraint(item: childView,attribute: NSLayoutConstraint.Attribute.bottom,relatedBy: NSLayoutConstraint.Relation.equal,toItem: superView,attribute: NSLayoutConstraint.Attribute.bottom,multiplier: 1,constant: b)
